        ...
        <VerticalTimeline>
          ...
          >
            ...
            <div className="mobile-timeline-meta">
              <span className="meta-location">New York City, NY</span>
              <span className="meta-date">Sept 2025 - Feb 2026</span>
            </div>
            <ul>
          ...
          >
            ...
            <div className="mobile-timeline-meta">
              <span className="meta-location">New York City, NY</span>
              <span className="meta-date">Dec 2024 - Sept 2025</span>
            </div>
            <ul>
          ...
          >
            ...
            <div className="mobile-timeline-meta">
              <span className="meta-location">Augusta, GA</span>
              <span className="meta-date">Jan 2022 - Dec 2022</span>
            </div>
            <ul>
          ...
          >
            ...
            <div className="mobile-timeline-meta">
              <span className="meta-location">Augusta, GA</span>
              <span className="meta-date">May 2021 - Dec 2021</span>
            </div>
            <ul>
